---
{"dg-publish":true,"permalink":"/spaces/home/notas/semestre-6/topologia-ii/2023-11-21/"}
---


<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/spaces/home/conceptos/semestre-6/equivalencia-de-compacidad-con-filtros/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/spaces/home/conceptos/semestre-6/equivalencia-de-compacidad-con-ultrafiltros/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/spaces/home/conceptos/semestre-6/teorema-de-tychonoff/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/spaces/home/conceptos/semestre-6/filtro-generado-por-una-red/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
> [!definition|*] [[Spaces/Home/Conceptos/Semestre 6/Filtro\|Filtro]] generado por una red
> 
...
> Sea ${} \mathcal{C}= \left\{T_{\lambda}: \lambda \in \Lambda \right\} {}$. Entonces ${} \mathcal{C} {}$ es [[Spaces/Home/Conceptos/Semestre 6/Base de filtro\|base]] para un [[Spaces/Home/Conceptos/Semestre 6/Filtro\|Filtro]] ${} \mathcal{F} {}$ llamado **[[Spaces/Home/Conceptos/Semestre 6/Filtro\|Filtro]] generado por la red**.
>
...
> [!theorem|*]
> Si ${} \mathcal{F} {}$ es el [[Spaces/Home/Conceptos/Semestre 6/Filtro\|Filtro]] generado por la red ${} (x_{\lambda})_{\lambda \in \Lambda} {}$ entonces ${} \mathcal{F} {}$ [[Spaces/Home/Conceptos/Semestre 6/Convergencia de filtros\|converge]] a ${} x {}$ si y sólo si ${} (x_{\lambda})_{\lambda \in \Lambda} {}$ converge a ${} x {}$.
> 
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/spaces/home/conceptos/semestre-6/red-basada-en-un-filtro/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
> 
> Sea ${} \mathcal{F} {}$ un [[Spaces/Home/Conceptos/Semestre 6/Filtro\|Filtro]] y ${} \mathcal{A}_{\mathcal{F}}= \left\{(x,F) \in X \times \mathcal{F}: x \in F \right\} {}$.
> Definimos el orden ${} \leq {}$ en ${} \mathcal{A}_{\mathcal{F}} {}$ como 
> ${} (x,F) \leq  (y,G) \iff  G\subseteq F {}.$
> Entonces ${} \mathcal{A}_{\mathcal{F}} {}$ es un [[Spaces/Home/Conceptos/Semestre 6/Conjunto dirigido\|Conjunto dirigido]]. Sea ${} q: \mathcal{A}_{\mathcal{F}} \to X {}$ dada por ${} q(x,F)=x {}$. Entonces ${} (q(x,F))_{(x,F) \in \mathcal{A}_{\mathcal{F}}} {}$ es una red en ${} X {}$ llamada la **red basada en el [[Spaces/Home/Conceptos/Semestre 6/Filtro\|Filtro]] ${} F {}$**
>
...
> [!theorem|*]
> Sea ${} \mathcal{F} {}$ un [[Spaces/Home/Conceptos/Semestre 6/Filtro\|Filtro]] y ${} (q(x,F))_{(x,F) \in \mathcal{A}_{\mathcal{F}}} {}$ [[Spaces/Home/Conceptos/Semestre 6/Red basada en un filtro\| red basada en ${} \mathcal{F} {}$ ]]. Entonces ${} \mathcal{F} {}$ converge a ${} x_{0} {}$ si y sólo si ${} (q(x,F))_{(x,F) \in \mathcal{A}_{\mathcal{F}}} {}$ converge a ${} x_{0} {}$.
> 
