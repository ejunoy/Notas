---
{"dg-publish":true,"permalink":"/spaces/home/notas/semestre-6/topologia-ii/2023-11-03/"}
---
...
> [!exercise|19]
> Sea $X$ un [[Spaces/Home/Conceptos/Semestre 6/Espacio topológico\|Espacio topológico]] compacto, $U\subseteq X$ abierto y $A\subseteq Y$ cerrado.
...
> [!exercise|13]
> Sean $X$ y $Y$ espacios primero numerables y $Z$ un [[Spaces/Home/Conceptos/Semestre 6/Espacio topológico\|Espacio topológico]] cualquiera. Supongamos que $\hat{f}:X \to C_{c}(Y,Z)$ es continua. Demuestra que $f:X \times Y \to Z$ es continua.
...
> [!exercise|8]
> Sea $X$ un [[Spaces/Home/Conceptos/Semestre 6/Espacio topológico\|Espacio topológico]] y $A\subseteq X$ un subconjunto compacto.
...
> [!exercise|26]
> Sea $X$ un [[Spaces/Home/Conceptos/Semestre 6/Espacio topológico\|Espacio topológico]]. Definimos $H(X)=\left\{ f:X \to X \vert f \text{ es un homeomorfismo }\right\}\subseteq C_{c}(X,X)$.
