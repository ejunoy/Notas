---
{"dg-publish":true,"permalink":"/spaces/home/notas/semestre-6/analisis-ii/2023-11-14/"}
---

*Nota.* Para esapcios de [[Spaces/Home/Conceptos/Semestre 6/Espacio de medida\|medida]] infinita no hay contenciones de los $\mathcal{L}_{p}(\mu)$ y $\mathcal{L}_{q}(\mu)$, $q,p \in (0,\infty).$
...
> [!exercise|67]
> Sea $(X,S,\mu)$ un [[Spaces/Home/Conceptos/Semestre 6/Espacio de medida\|Espacio de medida]] finita y $p \in (0,\infty)$. Prueba 
...
> [!exercise|69]
> Sea $(X,S,\mu)$ un [[Spaces/Home/Conceptos/Semestre 6/Espacio de medida\|Espacio de medida]] con $\mu(X)=1$. 
