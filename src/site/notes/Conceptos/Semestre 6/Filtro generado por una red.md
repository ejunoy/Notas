...
> Sea ${} \mathcal{C}= \left\{T_{\lambda}: \lambda \in \Lambda \right\} {}$. Entonces ${} \mathcal{C} {}$ es [[Conceptos/Semestre 6/Base de filtro\|base]] para un [[Conceptos/Semestre 6/Filtro\|filtro]] ${} \mathcal{F} {}$ llamado **[[Conceptos/Semestre 6/Filtro\|filtro]] generado por la red**.
>