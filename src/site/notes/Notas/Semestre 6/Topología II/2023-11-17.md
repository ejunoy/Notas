...
> [!theorem|*]
> Sea ${} \left\{(X_{\alpha},\tau_{\alpha})\right\}_{\alpha \in \mathcal{A}} {}$ una familia de espacios topológicos y ${} X=\prod_{\alpha \in \mathcal{A}}^{}X_{\alpha} {}.$ Un [[Conceptos/Semestre 6/Filtro\|filtro]] ${} \mathcal{F} {}$ en ${} X {}$ [[Conceptos/Semestre 6/Convergencia de filtros\|converge]] a ${} x_{0} \in X {}$ si y sólo si para cada ${} \alpha \in \mathcal{A} {}$ el [[Conceptos/Semestre 6/Filtro\|filtro]] ${} \pi_{\alpha}(\mathcal{F}) {}$ [[Conceptos/Semestre 6/Convergencia de filtros\|converge]] a ${} \pi_{\alpha}(x_{0}) {}$.
> 

*Demostración.*
- ${} \rightarrow {}$ Supongamos que ${} \mathcal{F} {}$ [[Conceptos/Semestre 6/Convergencia de filtros\|converge]] a ${} x_{0} {}$. Como ${} \pi_{\alpha} {}$ es continua para cada ${} \alpha \in \mathcal{A} {}$ entonces ${} \pi_{\alpha}(\mathcal{F}) {}$ [[Conceptos/Semestre 6/Convergencia de filtros\|converge]] a ${} \pi_{\alpha}(x_{0}) {}$.
- ${} \leftarrow {}$ Sea ${} U \in \mathcal{N}(x_{0}) {}$. Como ${} U \in \mathcal{N}(x_{0}) {}$ entonces existen ${} \alpha_{1},\alpha_{2},\dots,\alpha_{n} \in \mathcal{A} {}$    y ${} U_{\alpha_{i}} \subseteq X_{\alpha_{i}} {}$ abiertos con ${} \pi_{\alpha_{i}}(x_{0}) \in U_{i} {}$ y 
	...
	Entnoces ${} N(x_{0}) \in \mathcal{F}{}$ y ${} \mathcal{F} {}$  [[Conceptos/Semestre 6/Convergencia de filtros\|converge]] a ${} x_{0} {}$.
...
> [!theorem|*]
> Sea ${} \mathcal{G} {}$ un [[Conceptos/Semestre 6/Ultrafiltro\|ultrafiltro]]. Entonces ${} x {}$ es un punto de acumulación de ${} \mathcal{G} {}$ si y sólo si ${} \mathcal{G} {}$ [[Conceptos/Semestre 6/Convergencia de filtros\|converge]] a ${} x {}$.
> 

*Demostración.* Claramente si ${} \mathcal{G} {}$ [[Conceptos/Semestre 6/Convergencia de filtros\|converge]] a ${} x {}$ entonces ${} x {}$ es un punto de acumulación de ${} \mathcal{G} {}$. Si ${} x {}$ es un punto de acumulación de ${} \mathcal{G} {}$ entonces existe un [[Conceptos/Semestre 6/Filtro\|filtro]] ${} \mathcal{F} {}$ con ${} \mathcal{G}\subseteq \mathcal{F} {}$ que [[Conceptos/Semestre 6/Convergencia de filtros\|converge]] a ${} x {}$ y, como ${} \mathcal{G} {}$ es un [[Conceptos/Semestre 6/Ultrafiltro\|ultrafiltro]], entonces ${} \mathcal{G}= \mathcal{F} {}$ y ${} \mathcal{G} {}$ [[Conceptos/Semestre 6/Convergencia de filtros\|converge]] a ${} x {}$.             
