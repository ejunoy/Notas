...
*Nota.* Para esapcios de [[Conceptos/Semestre 6/Espacio de medida\|medida]] infinita no hay contenciones de los $\mathcal{L}_{p}(\mu)$ y $\mathcal{L}_{q}(\mu)$, $q,p \in (0,\infty).$
